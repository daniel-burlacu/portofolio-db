...
const SKILLS: Record<'frontend' | 'backend' | 'leadership' | 'apps' | 'ai' | 'cybersecurity', Skill[]> = {
  ...
  ai: [
    { name: 'AI / ML Fundamentals', stars: 3 },
    { name: 'Generative AI', stars: 4 },
    { name: 'Foundation Models', stars: 4 },
    { name: 'Amazon Bedrock', stars: 4 },
    { name: 'Prompt Engineering', stars: 4 },
    { name: 'Responsible AI', stars: 4 },
    { name: 'AI Security & Governance', stars: 4 },
    { name: 'Model Evaluation', stars: 4 },
    { name: 'RAG & Embeddings', stars: 3 },
    { name: 'Fine-tuning Concepts', stars: 3 },
    { name: 'AWS AI Services', stars: 4 },
    { name: 'SageMaker Concepts', stars: 4 },
    { name: 'AI Use Cases', stars: 4 },
  ],
  cybersecurity: [
    { name: 'OWASP Top 10', stars: 4 },
    { name: 'Web App Testing', stars: 4 },
    { name: 'Authentication & Access', stars: 4 },
